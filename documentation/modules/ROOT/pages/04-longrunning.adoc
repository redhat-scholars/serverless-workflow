...
- In _Event Type_ *type*: `OrderEventType`

- *Click* `Add Header` to the right of _Event Custom Headers_ and *type* `ce-orderid` and `1000` for _Header Name_ and _Value_

+
+
image::04_ce-header.png[custom event header]

- In _Event Data_ *copy* the following json: `{"orderId": "1000", "item": "1111"}`
