...
If you have *closed quarkus runtime*, start it again:
...
From the Quarkus terminal, type `d`, it should open for you the browser in the DevUI console: http://localhost:8080/q/dev/[]
