...
This section shows how to create a simple Serverless Workflow using https://start.kubesmarts.org/dev[Serverless Logic Web Tools].

[#basic-workflow]
== A basic workflow

. Open the https://start.kubesmarts.org/dev[Serverless Logic Web Tools] in your browser.

. *Select* `YAML` button in the _Create_ pane for _New Workflow_
+
image::02_webtool.png[New workflow]
...
+
image::02_new_swf.png[Workflow example]
