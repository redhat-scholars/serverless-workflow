...
. *Open* the home page of https://start.kubesmarts.org/dev[Serverless Logic Web Tools] 

  - If you already have it in your browser window, make sure to click on the top banner to open the home page
...
=== Add the external external service
